...
## Принятие решения и применение рекомендации
...
## Фаза 1 - План реализации. Технологический стек
...
## Фаза 1 - План реализации. Обоснование выбора технологического стека
...
```plantuml
@plantuml:slide9-phase1-timeline-overview.puml
```

---

## Диаграмма: Этапы разработки Фазы 1 (Анализ, проектирование и разработка инфраструктуры)

```plantuml
@plantuml:slide9-phase1-timeline-part1.puml
```

---

## Диаграмма: Этапы разработки Фазы 1 (Разработка алгоритмов и разработка интерфейсов)

```plantuml
@plantuml:slide9-phase1-timeline-part2.puml
```

---

## Диаграмма: Этапы разработки Фазы 1 (Интеграционное тестирование и развёртывание)

```plantuml
@plantuml:slide9-phase1-timeline-part3.puml
```
...
## Фаза 2 - План реализации. Технологический стек
...
```plantuml
@plantuml:slide10-phase2-timeline-overview.puml
```
---

## Диаграмма: Этапы разработки Фазы 2 (Анализ, подготовка, проектирование ML)

```plantuml
@plantuml:slide10-phase2-timeline-part1.puml
```
---

## Диаграмма: Этапы разработки Фазы 2 (ML инфраструктура, разработка моделей)

```plantuml
@plantuml:slide10-phase2-timeline-part2.puml
```
---

## Диаграмма: Этапы разработки Фазы 2 (Интеграция и тестирование)

```plantuml
@plantuml:slide10-phase2-timeline-part3.puml
```
